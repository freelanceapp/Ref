package com.apps.ref.activities_fragments.family.activity_map_delivery_location;
...
import com.apps.ref.databinding.ActivityMapFamilyDeliveryLocationBinding;
...
public class MapDeliveryLocationActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, Listeners.BackListener {
    private ActivityMapFamilyDeliveryLocationBinding binding;
    private String lang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_map_family_delivery_location);
        getDataFromIntent();
        initView();
    }
